    ...
    <header>
      <div className='bg-gray-800 py-3 px-5 lg:px-20 flex justify-between z-22'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <button
            className='w-[40px] h-[40px] bg-primary-color hover:bg-secondary-color rounded-full flex items-center justify-center z-10 mood-button hover:shadow-gray-700 shadow-lg shadow-gray-600 hidden md:block' 
            onClick={moodButton}
            aria-pressed={isDark}
      ...
      <div className={`${sidebarOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'} fixed inset-y-0 right-0 z-50 w-screen bg-dark-body/95 p-8 text-light-body transition-transform duration-300`}>
          ...
          <button
              className='w-[40px] h-[40px] bg-primary-color hover:bg-secondary-color rounded-full flex items-center justify-center z-10 mood-button hover:shadow-gray-700 shadow-lg shadow-gray-600 mt-5' 
              onClick={moodButton}
              aria-pressed={isDark}
              aria-label='Toggle dark mode'
              type='button'>
